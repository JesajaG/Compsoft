      ...
      {activeSection === "home" && (
        <>
          ...
          <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-red-50">
            <img
              src="https://ik.imagekit.io/1ejspnv0y/Compsoft/Compsoft_LJiX-fJm_?updatedAt=1758543467778"
              alt="Background"
              className="absolute inset-0 w-full h-full object-cover z-0"
            />
            <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-blue-50/20 to-red-50/30" />
            <motion.div
              ...
              <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-8 md:gap-12">
                ...
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-4 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://ik.imagekit.io/1ejspnv0y/aezIwRgtJ2YaLWoDzvhh4.png?updatedAt=1758499361201"
                ...
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-8 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://ik.imagekit.io/1ejspnv0y/Compsoft.png?updatedAt=1758454948362"
                      alt="Compsoft Communications"
                ...
                >
                  <div className="border-2 border-blue-800/40 rounded-xl p-4 shadow-2xl shadow-blue-900/25 bg-white/80 backdrop-blur-sm hover:shadow-3xl hover:shadow-blue-900/35 hover:border-blue-700/50 transition-all duration-500 hover:-translate-y-2 hover:scale-[1.02]">
                    <img
                      src="https://ik.imagekit.io/1ejspnv0y/DYQdgIg418fa0wxdz9wCP.png?updatedAt=1758499277054"
          ...
          <section className="py-16 bg-white">
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                >
                  <img
                    src="https://ik.imagekit.io/1ejspnv0y/Compsoft/istockphoto-1094914628-612x612.jpg?updatedAt=1758540544273"
                ...
                >
                  <img
                    src="https://ik.imagekit.io/1ejspnv0y/Compsoft/istockphoto-504480697-612x612.jpg?updatedAt=1758540544389"
                ...
                >
                  <img
                    src="https://ik.imagekit.io/1ejspnv0y/Compsoft/istockphoto-1337471411-612x612.jpg?updatedAt=1758540544423"
          ...
          {/* Contact section */}
          <section id="contact-info" className="py-24 border-t relative overflow-hidden bg-white">
